...
public interface MemberDao {
    ...
    @Select("select username, email, profile, join_day, level, where username=#{loginId}")
    Member findByUsername(String loginId);

    @Select("select password from memebers where username=#{loginId}")
